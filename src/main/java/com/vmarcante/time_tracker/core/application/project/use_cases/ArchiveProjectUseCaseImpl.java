...
public class ArchiveProjectUseCaseImpl implements ArchiveProjectUseCase {
    ...
    public ArchiveProjectUseCaseImpl(
    ...
    public ProjectDetailOutputDTO execute(UUID companyId, UUID projectId) throws ApplicationException {
        ...
        validationPolicy.validateStatusTransition(project.getStatus(), ProjectStatus.ARCHIVED);

        project.setStatus(ProjectStatus.ARCHIVED);
        project.setUpdatedBy(actorId);
        Project saved = projectRepository.save(project);

        log.info("[Archive Project] Project {} archived by {}", projectId, actorId);
