...
@Table(name = "TB0002_USER_AUTH", schema = "dbo", indexes = {
        @Index(name = "IX0002_USERNAME_HASH", columnList = "C0002_USERNAME_HASH", unique = true),
...
public class UserAuthJpaEntity implements BaseActiveEntityInterface<UUID, Integer> {
    ...
    // Entity Fields
    @Column(name = "C0002_USERNAME", nullable = false, columnDefinition = "TEXT")
    @Convert(converter = EncryptedStringConverter.class)
    private String username;

    @Column(name = "C0002_USERNAME_HASH", nullable = false, length = 64, unique = true)
    @EncryptedSearchable(sourceField = "username")
